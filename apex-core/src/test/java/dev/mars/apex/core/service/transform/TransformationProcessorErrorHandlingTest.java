...
class TransformationProcessorErrorHandlingTest {

    private static final Logger logger = LoggerFactory.getLogger(TransformationProcessorErrorHandlingTest.class);
    private TransformationProcessor transformationProcessor;

    @BeforeAll
    static void classSetUp() {
        MDC.put("testContext", "[EXPECTED] ");
        LoggerFactory.getLogger(TransformationProcessorErrorHandlingTest.class)
                .info("[INTENTIONAL-FAILURE-TEST-CLASS-START] TransformationProcessorErrorHandlingTest intentionally triggers ERROR/WARN logs");
        LoggerFactory.getLogger(TransformationProcessorErrorHandlingTest.class)
    ...
    @BeforeEach
    void setUp() {
        logger.info("Setting up TransformationProcessor for error handling tests");
    ...
    /**
     * NOTE: The error handling fix in TransformationProcessor.processTransformationsWithResult() ensures that:
     *
    ...
    static void classTearDown() {
        LoggerFactory.getLogger(TransformationProcessorErrorHandlingTest.class)
                .info("[INTENTIONAL-FAILURE-TEST-CLASS-END] TransformationProcessorErrorHandlingTest intentional error tests completed");
