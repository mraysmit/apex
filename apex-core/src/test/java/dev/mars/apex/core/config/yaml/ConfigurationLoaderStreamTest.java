...
/**
 * Unit tests for ConfigurationLoader stream-based loading methods.
 * 
 * <p>Tests the following methods added for Phase 1 of the Unified Resource Loading plan:</p>
 * <ul>
 *   <li>{@link ConfigurationLoader#loadAsMap(InputStream)}</li>
 *   <li>{@link ConfigurationLoader#loadAsMapFromClasspath(String)}</li>
 * </ul>
 * 
 ...
 * @since 3.0
 */
@DisplayName("ConfigurationLoader Stream Loading Tests")
class ConfigurationLoaderStreamTest {

    private static final Logger logger = LoggerFactory.getLogger(ConfigurationLoaderStreamTest.class);

    private ConfigurationLoader loader;

    @BeforeEach
    void setUp() {
        logger.info("Setting up ConfigurationLoaderStreamTest");
