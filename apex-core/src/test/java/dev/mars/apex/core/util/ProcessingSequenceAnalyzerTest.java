...
/**
 * Tests for ProcessingSequenceAnalyzer.
 *
 ...
 * are in apex-demo module: {@code ProcessingSequenceAnalyzerValidationTest}
 *
 * @author Mark Andrew Ray-Smith Cityline Ltd
 * @since 1.0.0
 */
@DisplayName("ProcessingSequenceAnalyzer Tests")
class ProcessingSequenceAnalyzerTest {
