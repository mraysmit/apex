...
/**
 * API-specific integration tests for ConfigurationLoader.
 * 
 * Tests focus on:
...
class ConfigurationLoaderTest {
    ...
    @Test
    @DisplayName("Should create ConfigurationLoader successfully")
    void testConstructor() {
        ConfigurationLoader testLoader = new ConfigurationLoader();
    ...
    @Test
    @DisplayName("Should throw ConfigurationException for non-existent file")
    void testLoadFromNonExistentFile() {
        ...
        }, "Should throw ConfigurationException for non-existent file");
    ...
    @Test
    @DisplayName("Should throw ConfigurationException for invalid YAML syntax")
