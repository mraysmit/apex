...
/**
 * Test to verify consistency between different loadFromFile methods in ConfigurationLoader.
 * 
 ...
 */
@DisplayName("ConfigurationLoader Consistency Tests")
public class ConfigurationLoaderConsistencyTest {
    ...
    void testValidationErrorConsistency() throws Exception {
        ...
        ConfigurationException exceptionFromString = assertThrows(ConfigurationException.class, () -> {
            loader.loadFromFile(invalidConfigFile.toString());
        }, "String path loading should throw ConfigurationException for invalid config");

        ConfigurationException exceptionFromFile = assertThrows(ConfigurationException.class, () -> {
            loader.loadFromFile(invalidConfigFile.toFile());
        }, "File object loading should throw ConfigurationException for invalid config");
