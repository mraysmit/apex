...
/**
 * Tests for {@link RuleFactory} index methods added in Phase 4 refactoring.
 * Validates that pre-built lookup maps provide O(1) access equivalent to iterating YAML lists.
 */
@ExtendWith(ColoredTestOutputExtension.class)
@DisplayName("RuleFactory Index Methods (Phase 4)")
class RuleFactoryIndexTest {
    ...
    class CreateRuleIndexTests {
        ...
        void equivalenceWithCreateRules() {
            ...
            RuleFactory fresh = new RuleFactory();
    ...
    class CreateRuleGroupIndexTests {
        ...
        void emptyGroups() throws ConfigurationException {
            YamlRuleConfiguration config = new YamlRuleConfiguration();
        ...
        void indexesByGroupId() throws ConfigurationException {
        ...
        void disabledGroupsExcluded() throws ConfigurationException {
            YamlRuleConfiguration config = createConfigWithRulesAndGroups();
        ...
        void equivalenceWithCreateRuleGroups() throws ConfigurationException {
            YamlRuleConfiguration config = createConfigWithRulesAndGroups();
            RulesEngineConfiguration engineConfig = buildEngineConfig(config);
