...
public class ScenarioStageExecutor {
    ...
    public ScenarioStageExecutor(ConfigurationLoader configLoader, RuleFactory ruleFactory) {
        this.configLoader = configLoader != null ? configLoader : new ConfigurationLoader();
        this.ruleFactory = ruleFactory != null ? ruleFactory : new RuleFactory();
        this.expressionEvaluator = new ExpressionEvaluatorService();
    }
    ...
    private StageExecutionResult executeConfigFile(
            ...
            String failurePolicy) throws ConfigurationException {
