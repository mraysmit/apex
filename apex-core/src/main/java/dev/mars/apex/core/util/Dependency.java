...
public class Dependency {
    ...
    public Dependency(String sourceFile, String targetFile, String referenceType) {
        this.sourceFile = sourceFile;
        this.targetFile = targetFile;
        this.referenceType = referenceType;
    }
    
    public Dependency(String sourceFile, String targetFile, String referenceType, String yamlPath) {
