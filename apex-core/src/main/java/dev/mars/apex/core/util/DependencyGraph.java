...
public class DependencyGraph {
    ...
    public DependencyGraph(String rootFile) {
    ...
    public void addDependency(Dependency dependency) {
        ...
        Node targetNode = nodes.get(dependency.getTargetFile());
        if (targetNode != null) {
     ...
     */
    public Node getNode(String filePath) {
