...
public class ValidationSummary {
    ...
    public int getWarningCount() {
        return (int) results.stream().filter(ValidationResult::hasWarnings).count();
    }
     ...
     */
    public List<ValidationResult> getResultsWithWarnings() {
        return results.stream()
    ...
    public String getReport() {
        ...
        // Show invalid files
        List<ValidationResult> invalidResults = getInvalidResults();
        ...
        List<ValidationResult> warningResults = getResultsWithWarnings();
        if (!warningResults.isEmpty()) {
            report.append("Files with Warnings:\n");
            report.append("--------------------\n");
            for (ValidationResult result : warningResults) {
