...
public class NamedOperation {
    ...
    public void validate() throws YamlConfigurationException {
        if (name == null || name.trim().isEmpty()) {
            throw new YamlConfigurationException("Named operation must have a 'name' field");
        }
        if (query == null || query.trim().isEmpty()) {
            throw new YamlConfigurationException("Named operation '" + name + "' must have a 'query' field");
        }
    }
