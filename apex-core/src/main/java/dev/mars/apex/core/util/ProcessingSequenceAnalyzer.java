 ...
 * <p>Example usage:
 * <pre>
 * ProcessingSequenceAnalyzer analyzer = new ProcessingSequenceAnalyzer();
 ...
 * @since 2025-11-08
 */
public class ProcessingSequenceAnalyzer {
    
    private static final Logger logger = LoggerFactory.getLogger(ProcessingSequenceAnalyzer.class);
     ...
     */
    public ProcessingSequenceAnalyzer() {
     ...
     * This is a simplified version of ConfigurationLoader.applyGroupsOnlyLogic()
