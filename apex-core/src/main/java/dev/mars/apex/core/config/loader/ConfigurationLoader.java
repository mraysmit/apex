...
public class ConfigurationLoader {
     ...
     */
    private void validateDataSources(YamlRuleConfiguration config) throws ConfigurationException {
        if (config.getDataSources() != null) {
     ...
     */
    private void validateRuleChains(YamlRuleConfiguration config) throws ConfigurationException {
     ...
     */
    private void validateCrossComponentReferences(YamlRuleConfiguration config) throws ConfigurationException {
     ...
     */
    private void validateEnrichmentReferences(YamlRuleConfiguration config) throws ConfigurationException {
        if (config.getEnrichments() == null || config.getEnrichments().isEmpty()) {
            return;
        }
     ...
     */
    private void validateDuplicates(YamlRuleConfiguration config) throws ConfigurationException {
