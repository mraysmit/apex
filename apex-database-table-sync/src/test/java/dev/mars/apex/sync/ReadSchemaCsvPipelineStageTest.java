...
class ReadSchemaCsvPipelineStageTest {
    ...
    void setUp() throws Exception {
        logger.info("=== Setting up Read Schema CSV Pipeline Stage Test ===");
    }
    ...
    void shouldReadSchemaFromCsv() throws Exception {
        ...
        rulesEngine = RulesEngine.fromFile("src/test/java/dev/mars/apex/sync/ReadSchemaCsvPipelineStageTest.yaml");
    ...
    void shouldReadSchemaFromLargeCsv() throws Exception {
        ...
        rulesEngine = RulesEngine.fromFile("src/test/java/dev/mars/apex/sync/ReadSchemaCsvPipelineStageTestLarge.yaml");
        assertNotNull(rulesEngine, "Rules engine should be created");
