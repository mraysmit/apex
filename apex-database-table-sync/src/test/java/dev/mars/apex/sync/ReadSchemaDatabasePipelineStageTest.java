...
class ReadSchemaDatabasePipelineStageTest {
    ...
    void setUp() throws Exception {
        logger.info("=== Setting up Read Schema Database Pipeline Stage Test ===");
    }
    ...
    void shouldReadSchemaFromDatabase() throws Exception {
        ...
        rulesEngine = RulesEngine.fromFile("src/test/java/dev/mars/apex/sync/ReadSchemaDatabasePipelineStageTest.yaml");
    ...
    void shouldReadSchemaFromMultipleTables() throws Exception {
        ...
        rulesEngine = RulesEngine.fromFile("src/test/java/dev/mars/apex/sync/ReadSchemaDatabasePipelineStageTestMultiTable.yaml");
        assertNotNull(rulesEngine, "Rules engine should be created");
