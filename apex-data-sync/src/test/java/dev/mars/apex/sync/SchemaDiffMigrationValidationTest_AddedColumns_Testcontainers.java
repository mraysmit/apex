...
class SchemaDiffMigrationValidationTest_AddedColumns_Testcontainers {
    ...
    @Container
    private static final PostgreSQLContainer<?> sourceDb = new PostgreSQLContainer<>(TestConstants.POSTGRES_IMAGE)
            .withDatabaseName("source_db")
            .withUsername("test")
            .withPassword("test");
    
    @Container
    private static final PostgreSQLContainer<?> targetDb = new PostgreSQLContainer<>(TestConstants.POSTGRES_IMAGE)
    ...
    void shouldValidateSafeSchemaEvolution() throws Exception {
        ...
        rulesEngine = RulesEngine.fromFile("src/test/java/dev/mars/apex/sync/SchemaDiffDatabaseMigrationValidationTest_AddedColumns_Testcontainers.yaml");
