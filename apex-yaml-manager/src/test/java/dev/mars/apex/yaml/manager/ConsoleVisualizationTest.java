...
/**
 * Test that demonstrates console visualization of YAML content summaries in the dependency tree.
 * Run this test to see the console output showing how content summaries are displayed.
 */
...
class ConsoleVisualizationTest {
    ...
    @Test
    @DisplayName("Display tree with content summaries in console")
    void testConsoleVisualization() {
        System.out.println("\n" + "=".repeat(100));
