 ...
 * and displaying content summaries for each YAML file.
 * 
 * Run with: mvn test-compile -pl apex-yaml-manager && java -cp "apex-yaml-manager/target/classes;apex-yaml-manager/target/test-classes" dev.mars.apex.yaml.manager.NestedDependencyTreeConsoleDemo
 */
