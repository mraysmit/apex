...
/**
 * Standalone runner to display console visualization.
 * Run with: mvn exec:java -Dexec.mainClass="dev.mars.apex.yaml.manager.RunConsoleVisualization" -pl apex-yaml-manager
 */
public class RunConsoleVisualization {
