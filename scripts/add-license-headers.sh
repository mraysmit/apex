...
# Adds Apache License 2.0 headers to Java files in the APEX Rules Engine project.
#
# Usage:
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "Adds Apache License 2.0 headers to Java files in the APEX Rules Engine project."
            echo ""
            echo "Options:"
