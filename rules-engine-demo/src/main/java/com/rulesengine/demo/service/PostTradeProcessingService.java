 ...
 * Uses the RulesEngine to evaluate settlement rules.
 */
public class PostTradeProcessingService {
    ...
    /**
     * Calculate settlement fee for a trade using the RulesEngine.
     * 
    ...
    /**
     * Calculate settlement days for a trade using the RulesEngine.
     * 
     * @param trade The trade
    ...
    public boolean validateTradeForSettlement(Trade trade) {
        RuleResult result = validateTradeForSettlementWithResult(trade);
    ...
    public boolean matchTradeWithCounterparty(Trade trade) {
        RuleResult result = matchTradeWithCounterpartyWithResult(trade);
        return result.isTriggered();
    }
    ...
    public boolean affirmTrade(Trade trade) {
        RuleResult result = affirmTradeWithResult(trade);
        return result.isTriggered();
    }
    ...
    public boolean confirmTrade(Trade trade) {
        RuleResult result = confirmTradeWithResult(trade);
        return result.isTriggered();
    }
    ...
    public boolean settleTrade(Trade trade) {
        RuleResult result = settleTradeWithResult(trade);
        return result.isTriggered();
    }
    ...
    /**
     * Calculate clearing fee for a trade using the RulesEngine.
     * 
     * @param trade The trade
    ...
    /**
     * Calculate custody fee for a trade using the RulesEngine.
     * 
     * @param trade The trade
