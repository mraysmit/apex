...
public class MockDataSource implements DataSource {
    ...
    private void initializeProducts() {
        ...
        products.add(new Product("Apple Inc.", 180.0, "Equity"));
    ...
    private void initializeInventory() {
        ...
        inventory.add(new Product("Corporate Bond", 950.0, "FixedIncome"));
        inventory.add(new Product("Microsoft Corp", 350.0, "Equity"));
        dataStore.put("inventory", inventory);
    }

    private void initializeCustomer() {
        Customer customer = new Customer("Alice Smith", 35, "Gold", new ArrayList<>());
        dataStore.put("customer", customer);
    }

    private void initializeTemplateCustomer() {
        Customer templateCustomer = new Customer("Bob Johnson", 42, "Silver", new ArrayList<>());
    ...
    private void initializeLookupServices() {
        ...
        List<String> assetClassValues = Arrays.asList("Equity", "FixedIncome", "Commodity", "Currency");
