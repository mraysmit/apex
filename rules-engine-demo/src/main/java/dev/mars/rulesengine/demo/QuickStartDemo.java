...
public class QuickStartDemo {
    ...
    public void run() {
        ...
        System.out.println("✅ Quick Start demonstration completed!");
    ...
    private void demonstrateYamlConfiguration() {
        ...
        try {
            ...
            if (yamlStream != null) {
                ...
                System.out.println("⚠️  YAML configuration file not found (will be created in next step)");
                System.out.println("   Expected location: /demo-rules/quick-start.yaml");
            }
            
        } catch (Exception e) {
            System.out.println("⚠️  Error loading YAML configuration: " + e.getMessage());
