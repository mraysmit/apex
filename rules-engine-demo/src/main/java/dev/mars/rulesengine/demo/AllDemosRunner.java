...
public class AllDemosRunner {
    ...
    private static final String DEMO_BASE_PACKAGE = "dev.mars.rulesengine.demo";
    ...
    private void registerKnownDemoClasses() {
        // Core demos
        registerDemoClass("dev.mars.rulesengine.demo.examples.QuickStartDemo");
        registerDemoClass("dev.mars.rulesengine.demo.examples.YamlDatasetDemo");
        registerDemoClass("dev.mars.rulesengine.demo.examples.FinancialServicesDemo");
        registerDemoClass("dev.mars.rulesengine.demo.examples.PerformanceDemo");
        registerDemoClass("dev.mars.rulesengine.demo.core.LayeredAPIDemo");
        registerDemoClass("dev.mars.rulesengine.demo.examples.SimplifiedAPIDemo");
        registerDemoClass("dev.mars.rulesengine.demo.examples.YamlConfigurationDemo");
        registerDemoClass("dev.mars.rulesengine.demo.examples.BatchProcessingDemo");

        // Examples demos
        registerDemoClass("dev.mars.rulesengine.demo.examples.BasicUsageExamples");
        registerDemoClass("dev.mars.rulesengine.demo.examples.LayeredAPIDemo");
        registerDemoClass("dev.mars.rulesengine.demo.examples.AdvancedFeaturesDemo");
        registerDemoClass("dev.mars.rulesengine.demo.examples.CommoditySwapValidationDemo");
        registerDemoClass("dev.mars.rulesengine.demo.examples.FinancialTradingDemo");
        registerDemoClass("dev.mars.rulesengine.demo.examples.IntegrationExamples");
        registerDemoClass("dev.mars.rulesengine.demo.examples.PerformanceMonitoringDemo");

        // Integration demos
        registerDemoClass("dev.mars.rulesengine.demo.advanced.DataServiceManagerDemo");
        registerDemoClass("dev.mars.rulesengine.demo.advanced.DynamicMethodExecutionDemo");
        registerDemoClass("dev.mars.rulesengine.demo.advanced.PerformanceAndExceptionDemo");
        registerDemoClass("dev.mars.rulesengine.demo.advanced.RuleConfigurationDemo");
        registerDemoClass("dev.mars.rulesengine.demo.advanced.SpelAdvancedFeaturesDemo");
        registerDemoClass("dev.mars.rulesengine.demo.advanced.SpelRulesEngineDemo");

        // Advanced demos
        registerDemoClass("dev.mars.rulesengine.demo.advanced.AdvancedFeaturesDemo");
        registerDemoClass("dev.mars.rulesengine.demo.advanced.IntegrationExamples");
        registerDemoClass("dev.mars.rulesengine.demo.advanced.PerformanceMonitoringDemo");

        // Financial demos
        registerDemoClass("dev.mars.rulesengine.demo.financial.CommoditySwapValidationDemo");
    }
