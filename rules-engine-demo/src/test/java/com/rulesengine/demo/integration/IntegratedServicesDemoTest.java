...
public class IntegratedServicesDemoTest {
    ...
    public void testProductDiscounts() {
        ...
        // Get product enricher
        ProductEnricher productEnricher = (ProductEnricher) registry.getService("productEnricher", ProductEnricher.class);

        // Apply discount directly using the ProductEnricher
        Product discountedProduct = productEnricher.enrich(expensiveProduct, discount);
