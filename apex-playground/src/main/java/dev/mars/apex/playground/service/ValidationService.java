...
public class ValidationService {
     ...
     */
    public ValidationResponse getValidationErrors(String yamlContent) {
     ...
     */
    private void validateYamlSyntax(String yamlContent, ValidationResponse response) {
        try {
     ...
     */
    private void validateApexStructure(String yamlContent, ValidationResponse response) {
        try {
     ...
     */
    private void extractAndValidateMetadata(String yamlContent, ValidationResponse response) {
        try {
            ...
            try {
                MetadataValidator.validateMetadataAndThrow(yamlMap, "playground-editor");
            } catch (ConfigurationException e) {
            ...
            if (yamlMap.containsKey("metadata")) {
                ...
                ValidationResponse.Metadata metadata = new ValidationResponse.Metadata();
     ...
     */
    @SuppressWarnings("unchecked")
    private void updateStatistics(String yamlContent, ValidationResponse response) {
        try {
            Map<String, Object> yamlMap = parseYamlAsMap(yamlContent);
