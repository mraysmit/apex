...
class ValidationServiceTest {
    ...
    class ValidYamlTests {
        ...
        void shouldValidateCompleteYamlConfiguration() {
            ...
            // When
            ValidationResponse response = yamlValidationService.validateYaml(validYaml);
        ...
        void shouldValidateYamlWithEnrichments() {
            ...
            // When
            ValidationResponse response = yamlValidationService.validateYaml(yamlWithEnrichments);
        ...
        void shouldValidateMinimalYamlConfiguration() {
            ...
            // When
            ValidationResponse response = yamlValidationService.validateYaml(minimalYaml);
    ...
    class InvalidYamlTests {
        ...
        void shouldDetectYamlSyntaxErrors() {
            ...
            // When
            ValidationResponse response = yamlValidationService.validateYaml(invalidYaml);
        ...
        void shouldDetectMissingRequiredFields() {
            ...
            // When
            ValidationResponse response = yamlValidationService.validateYaml(yamlMissingFields);
        ...
        void shouldHandleEmptyYamlContent() {
            // When
            ValidationResponse response = yamlValidationService.validateYaml("");
        ...
        void shouldHandleNullYamlContent() {
            // When
            ValidationResponse response = yamlValidationService.validateYaml(null);
        ...
        void shouldDetectConfigurationWithoutRulesOrEnrichments() {
            ...
            // When
            ValidationResponse response = yamlValidationService.validateYaml(emptyConfig);
    ...
    class MetadataExtractionTests {
        ...
        void shouldExtractCompleteMetadata() {
            ...
            // When
            ValidationResponse response = yamlValidationService.validateYaml(yamlWithMetadata);
        ...
        void shouldWarnAboutMissingMetadataFields() {
            ...
            // When
            ValidationResponse response = yamlValidationService.validateYaml(yamlWithIncompleteMetadata);
    ...
    class ErrorDetailsTests {
        ...
        void shouldProvideDetailedValidationErrors() {
            ...
            // When
            ValidationResponse response = yamlValidationService.validateYaml(yamlWithErrors);
            ...
            ValidationResponse.ValidationIssue firstError = response.getErrors().get(0);
        ...
        void shouldReturnSameResultForGetValidationErrors() {
            ...
            // When
            ValidationResponse response1 = yamlValidationService.validateYaml(yaml);
            ValidationResponse response2 = yamlValidationService.getValidationErrors(yaml);
    ...
    class StatisticsTests {
        ...
        void shouldCountRulesAndEnrichmentsCorrectly() {
            ...
            // When
            ValidationResponse response = yamlValidationService.validateYaml(yamlWithBoth);
        ...
        void shouldCountErrorsAndWarningsCorrectly() {
            ...
            // When
            ValidationResponse response = yamlValidationService.validateYaml(yamlWithIssues);
