...
#### **3. [Financial Services Guide](old/APEX_FINANCIAL_SERVICES_DESIGN.md)**
...
4. **[Financial Services Guide](old/APEX_FINANCIAL_SERVICES_DESIGN.md)** - Domain-specific patterns and compliance
...
### **Migration Path**
1. **Review changes** in [Financial Services Guide](old/APEX_FINANCIAL_SERVICES_DESIGN.md) (15 minutes)
