...
/**
 * Configuration class for ApexAdvancedFeaturesDemo.
 *
...
public class ApexAdvancedFeaturesDemoConfig {
    ...
    private final ApexAdvancedFeaturesDataProvider dataProvider;
    
    /**
     * Create a new ApexAdvancedFeaturesDemoConfig with the specified services.
     *
     ...
     */
    public ApexAdvancedFeaturesDemoConfig(
        ...
        this.dataProvider = new ApexAdvancedFeaturesDataProvider();
    }
     ...
     */
    public ApexAdvancedFeaturesDataProvider getDataProvider() {
        return dataProvider;
    }
}
