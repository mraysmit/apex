 ...
 */
public class RuleConfigurationDemo {

    private static final Logger logger = LoggerFactory.getLogger(RuleConfigurationDemo.class);
    ...
    public RuleConfigurationDemo() {
        ...
        logger.info("RuleConfigurationDemo initialized with real APEX services");
