 ...
 * ├── infrastructure/bootstrap/datasets/customer-profiles.yaml
 ...
 * │
 * ├── infrastructure/bootstrap/datasets/product-catalog.yaml
 ...
 * │
 * └── infrastructure/bootstrap/datasets/trading-scenarios.yaml
...
public class DemoDataBootstrap {
    ...
    private void populateCustomers() throws SQLException {
        ...
        try {
            ...
            YamlRuleConfiguration customerConfig = yamlLoader.loadFromClasspath("infrastructure/bootstrap/datasets/customer-profiles.yaml");
    ...
    private void populateProducts() throws SQLException {
        ...
        try {
            ...
            YamlRuleConfiguration productConfig = yamlLoader.loadFromClasspath("infrastructure/bootstrap/datasets/product-catalog.yaml");
    ...
    private void populateTrades() throws SQLException {
        ...
        try {
            ...
            YamlRuleConfiguration tradeConfig = yamlLoader.loadFromClasspath("infrastructure/bootstrap/datasets/trading-scenarios.yaml");
    ...
    private void loadExternalConfiguration() throws Exception {
        ...
        try {
            ...
            YamlRuleConfiguration mainConfig = yamlLoader.loadFromClasspath("infrastructure/bootstrap/demo-data-bootstrap.yaml");
