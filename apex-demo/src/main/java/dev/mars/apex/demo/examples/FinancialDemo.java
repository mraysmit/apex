...
public class FinancialDemo {
    ...
    private FinancialTrade createTradeFromData(String tradeId) {
        ...
        List<Map<String, Object>> tradeData = DemoDataLoader.loadTradeData("demo-data/financial/trades.yaml");
    ...
    private Map<String, Object> loadFinancialConfiguration() {
        return DemoDataLoader.loadConfiguration("demo-data/financial/config.yaml");
    }
    ...
    private Map<String, Object> loadRiskScenarios() {
        return DemoDataLoader.loadYamlMap("demo-data/financial/risk-scenarios.yaml", () -> {
