package dev.mars.apex.demo.runners.industry;

import dev.mars.apex.demo.financial.ComprehensiveFinancialSettlementDemo;
 ...
 * 
 * FINANCIAL SERVICES:
 * - Trade Settlement Processing: Complete settlement workflow
...
public class IndustryRunner {
    ...
    private static void runFinancialServicesDemo() {
        ...
        logger.info("• Trade settlement and clearing");
