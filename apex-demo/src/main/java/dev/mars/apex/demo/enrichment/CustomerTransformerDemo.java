...
/**
 * APEX Customer Transformer Demo.
 *
...
public class CustomerTransformerDemo {
    ...
    /**
     * Run the customer transformer demo.
     */
    public void runDemo() throws Exception {
        LOGGER.info("=== APEX Customer Transformer Demo ===");
    ...
    private YamlRuleConfiguration loadConfiguration() throws Exception {
        ...
        return loader.loadFromClasspath("enrichment/customer-transformer-demo.yaml");
    }
    ...
    private Map<String, Object> createSampleData() {
        ...
        data.put("preferredCategory", "ETF");
        data.put("transformationType", "customer-transformation");
        return data;
    }
