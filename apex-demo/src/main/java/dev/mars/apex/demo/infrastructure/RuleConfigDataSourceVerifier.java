...
public class RuleConfigDataSourceVerifier {
    ...
    private boolean verifyExternalYamlConfigurations() {
        ...
        try {
            String[] requiredConfigFiles = {
                "src/main/resources/infrastructure/enhanced-enterprise-rules.yaml",
                "src/main/resources/infrastructure/financial-validation-rules.yaml",
                "src/main/resources/infrastructure/derivatives-validation-rules.yaml",
                "src/main/resources/infrastructure/settlement-validation-rules.yaml"
            };
    ...
    private boolean verifyInlineDatasets() {
        ...
        try {
            ...
            Path mainConfigPath = Paths.get("src/main/resources/infrastructure/enhanced-enterprise-rules.yaml");
