...
public class ExternalDataSourceReferenceValidationTest {
    ...
    private void testConfigurationValidation() throws Exception {
        ...
        YamlRuleConfiguration customerConfig = configLoader.loadFromClasspath("lookup/customer-profile-enrichment.yaml");
        YamlRuleConfiguration settlementConfig = configLoader.loadFromClasspath("lookup/settlement-instruction-enrichment.yaml");
