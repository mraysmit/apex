...
public class ApexAdvancedFeaturesDemo {
    // Config and services
    private final ApexAdvancedFeaturesDemoConfig config;
     ...
     */
    public ApexAdvancedFeaturesDemo(ApexAdvancedFeaturesDemoConfig config) {
        this.config = config;
    ...
    public static void main(String[] args) {
        ...
        ApexAdvancedFeaturesDemoConfig config = new ApexAdvancedFeaturesDemoConfig(
            rulesEngine,
            evaluatorService,
            ruleEngineService,
        ...
        ApexAdvancedFeaturesDemo spelAdvancedFeaturesDemo = new ApexAdvancedFeaturesDemo(config);
