package dev.mars.apex.demo.runners.patterns;

import dev.mars.apex.demo.examples.lookups.SimpleFieldLookupDemo;
import dev.mars.apex.demo.examples.lookups.ConditionalExpressionLookupDemo;
import dev.mars.apex.demo.examples.lookups.NestedFieldLookupDemo;
import dev.mars.apex.demo.examples.lookups.CompoundKeyLookupDemo;
import dev.mars.apex.demo.lookup.ComprehensiveLookupDemo;
...
public class PatternsRunner {
    ...
    private static void runLookupPatterns() {
        ...
        runLookupDemo("Conditional Expression Lookup",
                     ...
                     () -> ConditionalExpressionLookupDemo.main(new String[]{}));
        ...
        runLookupDemo("Comprehensive Lookup",
                     ...
                     () -> ComprehensiveLookupDemo.main(new String[]{}));
