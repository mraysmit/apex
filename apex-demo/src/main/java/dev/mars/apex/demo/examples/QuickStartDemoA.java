 ...
 *
 * This demo demonstrates the three core approaches to using the APEX Rules Engine:
 ...
 * @version 1.0
 */
public class QuickStartDemoA {

    private static final Logger logger = LoggerFactory.getLogger(QuickStartDemoA.class);
    private final RulesService rulesService;
    
    public QuickStartDemoA() {
    ...
    private Customer createSampleCustomer() {
        logger.debug("Creating sample customer for demonstration");
        ...
        // Note: Customer class doesn't have balance field, so balance validations will fail
        // This is intentional to demonstrate both passing and failing validations

        logger.debug("Created sample customer: name={}, age={}, email={}",
