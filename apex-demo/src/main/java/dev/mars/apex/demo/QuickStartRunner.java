...
import dev.mars.apex.demo.examples.QuickStartDemoB;
...
public class QuickStartRunner {
    ...
    private static void runCoreQuickStartDemo() {
        ...
        try {
            // Run the existing QuickStartDemoB
            QuickStartDemoB demo = new QuickStartDemoB();
            demo.run();
    ...
    private static void showNextSteps() {
        ...
        logger.info("");
        logger.info("Run individual runners: java -cp ... dev.mars.apex.demo.FundamentalsRunner");
        logger.info("");
    }
}
