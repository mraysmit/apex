...
import dev.mars.apex.demo.bootstrap.model.TradeB;
import dev.mars.apex.demo.bootstrap.model.TradeConfirmation;
import dev.mars.apex.demo.bootstrap.model.TradeHeader;
import dev.mars.apex.demo.bootstrap.model.PartyTradeIdentifier;
import dev.mars.apex.demo.bootstrap.model.Security;
import dev.mars.apex.demo.bootstrap.model.Counterparty;
import dev.mars.apex.demo.bootstrap.model.Header;
...
public class ComprehensiveFinancialSettlementDemo {
    ...
    private void processTradeWithEnrichment(TradeConfirmation trade, String configPath, String tradeDescription) {
        try {
            ...
            LOGGER.info("TradeB ID: {}", trade.getTrade().getTradeHeader().getPartyTradeIdentifier().getTradeId());
            ...
            LOGGER.info("TradeB Value: {} {} (Quantity: {}, Price: {})",
            ...
            LOGGER.info("TradeB processing completed for: {}", tradeDescription);
    ...
    private void displayRiskEnrichment(Map<String, Object> enrichedData) {
        ...
        if (trade instanceof Map) {
            ...
            // TradeB value
            logField("    TradeB Value", tradeMap.get("tradeValue"));
            logField("    TradeB Value USD", tradeMap.get("tradeValueUSD"));
    ...
    /**
     * Create UK Equity TradeB - Royal Dutch Shell PLC
    ...
    /**
     * Create US Government Bond TradeB - 10Y Treasury Note
    ...
    /**
     * Create German Equity TradeB - SAP SE
    ...
    /**
     * Create High-Value US Equity TradeB - Apple Inc
    ...
    private TradeConfirmation createHighValueUSEquityTrade() {
        ...
        // TradeB - High value trade (500,000 shares * $190 = $95M)
        confirmation.setTrade(createTrade(
            "TRD-004-2024",
            LocalDate.of(2024, 12, 24),
            "US0378331005",
     ...
     */
    private Header createHeader(String messageId, String sentBy, String sendTo) {
