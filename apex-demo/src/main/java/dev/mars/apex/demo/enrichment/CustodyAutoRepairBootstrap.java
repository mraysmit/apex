...
public class CustodyAutoRepairBootstrap {
    ...
    /**
     * Run the custody auto-repair demo.
     */
    public void runDemo() throws Exception {
        LOGGER.info("=== APEX Custody Auto-Repair Demo ===");
    ...
    private YamlRuleConfiguration loadConfiguration() throws Exception {
        ...
        return loader.loadFromClasspath("enrichment/custody-auto-repair-bootstrap-demo.yaml");
    }
    ...
    private Map<String, Object> createSampleData() {
        ...
        data.put("instructionId", "SI_001");
        data.put("clientId", "CLIENT_001");
        data.put("instrumentType", "EQUITY");
        data.put("amount", "10000");
        data.put("currency", "USD");
        data.put("bootstrapType", "standing-instructions-processing");
        data.put("instructionType", "client-level-instructions");
        return data;
    }
