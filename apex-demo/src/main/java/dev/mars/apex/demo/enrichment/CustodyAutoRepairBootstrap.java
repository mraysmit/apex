...
import dev.mars.apex.demo.model.BootstrapStandingInstruction;
 ...
 * java -cp apex-demo.jar dev.mars.apex.demo.enrichment.CustodyAutoRepairBootstrap
 *
...
public class CustodyAutoRepairBootstrap {
    ...
    private void loadYamlConfiguration() throws Exception {
        ...
        try {
            ...
            this.yamlConfig = loader.loadFromClasspath("infrastructure/bootstrap/custody-auto-repair-bootstrap.yaml");
