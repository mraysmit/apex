...
/**
 * APEX OTC Options Bootstrap Demo.
 *
...
public class OtcOptionsBootstrapDemo {
    ...
    /**
     * Run the OTC options bootstrap demo.
     */
    public void runDemo() throws Exception {
        LOGGER.info("=== APEX OTC Options Bootstrap Demo ===");
    ...
    private YamlRuleConfiguration loadConfiguration() throws Exception {
        ...
        return loader.loadFromClasspath("enrichment/otc-options-bootstrap-demo.yaml");
    }
    ...
    private Map<String, Object> createSampleData() {
        ...
        data.put("optionId", "OTC_001");
        data.put("underlyingAsset", "Natural Gas");
        data.put("optionType", "Call");
        data.put("strikePrice", "3.50");
        data.put("currency", "USD");
        data.put("notional", "10000");
        data.put("bootstrapType", "otc-options-bootstrap");
        return data;
    }
