...
public class OtcOptionsBootstrapDemo {
    ...
    private void loadYamlConfiguration() {
        ...
        try {
            ...
            logger.info("Target file: infrastructure/bootstrap/otc-options-bootstrap.yaml");
            ...
            var configResource = getClass().getClassLoader().getResource("infrastructure/bootstrap/otc-options-bootstrap.yaml");
    ...
    private void initializeDataSources() throws Exception {
        ...
        YamlRuleConfiguration dataSourceConfig = configLoader.loadFromClasspath("infrastructure/demo-data-sources.yaml");
