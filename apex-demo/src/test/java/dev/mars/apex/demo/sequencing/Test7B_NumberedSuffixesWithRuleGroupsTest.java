...
public class Test7B_NumberedSuffixesWithRuleGroupsTest extends DemoTestBase {
    ...
    public void testNumberedSuffixesWithRuleGroups() throws Exception {
        ...
        RulesEngine engine = RulesEngine.fromFile("src/test/java/dev/mars/apex/demo/sequencing/order_guarantee/Test7B_NumberedSuffixesWithRuleGroupsTest.yaml");
        ...
        LOGGER.info("✓ TEST 7B PASSED: All 5 definitive assertion types verified");
        ...
        LOGGER.info("  ✓ Numbered suffixes + rule groups: Work correctly together");
    }
}
