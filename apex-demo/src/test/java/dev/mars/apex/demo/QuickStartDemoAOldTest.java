...
import dev.mars.apex.demo.examples.QuickStartDemoA;
...
/**
 * Comprehensive tests for QuickStartDemoB to verify all documented functionality works exactly as specified.
 * 
 ...
 * @version 1.0
 */
class QuickStartDemoAOldTest {
    
    private ByteArrayOutputStream outputStream;
    private PrintStream originalOut;
    private QuickStartDemoA demo;
