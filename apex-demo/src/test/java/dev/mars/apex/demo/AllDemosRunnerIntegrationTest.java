...
/**
 * Integration test for AllDemosRunner to verify actual demo execution.
 */
public class AllDemosRunnerIntegrationTest {
    ...
    public void testRunQuickStartDemo() {
        ...
        System.setOut(originalOut);
        System.out.println("QuickStartDemo output length: " + output.length() + " characters");
