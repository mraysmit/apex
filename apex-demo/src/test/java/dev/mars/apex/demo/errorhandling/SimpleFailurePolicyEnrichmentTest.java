...
public class SimpleFailurePolicyEnrichmentTest extends DemoTestBase {
    ...
    void testEnrichmentAfterValidationFailure() throws Exception {
        ...
        // Load enrichment scenario using RulesEngine
        RulesEngine engine = RulesEngine.fromScenarioRegistry("src/test/java/dev/mars/apex/demo/errorhandling/SimpleFailurePolicyEnrichmentTest.yaml");
        ...
        // Execute scenario
        ScenarioExecutionResult scenarioResult = engine.evaluateScenario("enrichment-test", testData);
    ...
    void testEnrichmentWithMissingData() throws Exception {
        ...
        // Execute scenario
        ScenarioExecutionResult scenarioResult = engine.evaluateScenario("enrichment-test", minimalData);
