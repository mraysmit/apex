...
public class AllDemosRunnerCommandLineTest {
    ...
    public void testAllCommandLineOptions() {
        ...
        System.out.println("  java dev.mars.apex.demo.AllDemosRunner");
        System.out.println("  java dev.mars.apex.demo.AllDemosRunner --list");
        System.out.println("  java dev.mars.apex.demo.AllDemosRunner --package core");
        System.out.println("  java dev.mars.apex.demo.AllDemosRunner --package examples");
    }
}
