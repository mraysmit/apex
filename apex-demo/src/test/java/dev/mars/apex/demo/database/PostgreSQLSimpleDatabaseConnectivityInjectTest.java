 ...
 */
@Testcontainers
public class PostgreSQLSimpleDatabaseConnectivityInjectTest extends DemoTestBase {

    private static final Logger logger = LoggerFactory.getLogger(PostgreSQLSimpleDatabaseConnectivityInjectTest.class);
    ...
    void testPostgreSQLDatabaseConnectivity() {
        ...
        try {
            YamlRuleConfiguration config = yamlLoader.loadFromFile(
                "src/test/java/dev/mars/apex/demo/database/PostgreSQLSimpleDatabaseConnectivityInjectTest.yaml");
