...
public class CommoditySwapValidationTest {
    ...
    void testRulePerformance() {
        ...
        // Assert that average execution time is reasonable (less than 2ms per rule)
        assertTrue(avgTimeMs < 2.0, "Average rule execution time should be less than 2ms, was: " + avgTimeMs + "ms");
    }
