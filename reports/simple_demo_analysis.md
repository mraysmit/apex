...
|------------|-----------------|
| ApexAdvancedFeaturesDemo | evaluation/apex-advanced-features-demo.yaml; evaluation/advanced-features/collection-operations-config.yaml; evaluation/advanced-features/rule-engine-config.yaml; evaluation/advanced-features/template-processing-config.yaml; evaluation/advanced-features/dynamic-lookup-config.yaml; evaluation/advanced-features/rule-result-features-config.yaml; evaluation/advanced-features/advanced-features-test-data.yaml |
| ApexRulesEngineDemo | apex-rules-engine-demo-config.yaml |
| BasicUsageExamples | validation/basic-usage-examples-config.yaml |
| BatchProcessingDemo | transformation/batch-processing-demo-config.yaml |
| CommoditySwapValidationBootstrap | validation/commodity-swap-validation-bootstrap-demo.yaml; validation/commodity-bootstrap/validation-rules-config.yaml; validation/commodity-bootstrap/enrichment-patterns-config.yaml; validation/commodity-bootstrap/commodity-data-config.yaml |
| ComplianceServiceDemo | evaluation/compliance-service-demo.yaml; evaluation/compliance/regulatory-requirements.yaml; evaluation/compliance/reporting-deadlines.yaml; evaluation/compliance/compliance-rules.yaml; evaluation/compliance/compliance-test-data.yaml |
| ComprehensiveFinancialSettlementDemo | comprehensive-financial-settlement-demo-config.yaml |
| CustodyAutoRepairBootstrap | enrichment/custody-auto-repair-bootstrap-demo.yaml; enrichment/custody-bootstrap/standing-instructions-config.yaml; enrichment/custody-bootstrap/settlement-scenarios-config.yaml; enrichment/custody-bootstrap/auto-repair-rules-config.yaml |
| CustodyAutoRepairDemo | custody-auto-repair-demo-config.yaml |
| CustomerTransformerDemo | enrichment/customer-transformer-demo.yaml; enrichment/customer-transformer/transformer-rules-config.yaml; enrichment/customer-transformer/field-actions-config.yaml; enrichment/customer-transformer/customer-segments-config.yaml |
| DataManagementDemo | enrichment/data-management-demo-config.yaml |
| DemoDataBootstrap | infrastructure/bootstrap/datasets/customer-profiles.yaml; infrastructure/bootstrap/datasets/customer-profiles.yaml; infrastructure/bootstrap/datasets/product-catalog.yaml; infrastructure/bootstrap/datasets/product-catalog.yaml; infrastructure/bootstrap/datasets/trading-scenarios.yaml; infrastructure/bootstrap/demo-data-bootstrap.yaml; infrastructure/bootstrap/datasets/customer-profiles.yaml; infrastructure/bootstrap/datasets/product-catalog.yaml; infrastructure/bootstrap/datasets/trading-scenarios.yaml; infrastructure/bootstrap/datasets/customer-profiles.yaml; infrastructure/bootstrap/datasets/product-catalog.yaml; infrastructure/bootstrap/datasets/trading-scenarios.yaml; infrastructure/bootstrap/datasets/trading-scenarios.yaml |
| DemoDataProvider | infrastructure/demo-data-provider.yaml; infrastructure/datasets/customer-profiles.yaml; infrastructure/datasets/product-catalog.yaml; infrastructure/datasets/trading-scenarios.yaml; infrastructure/datasets/customer-profiles.yaml; infrastructure/datasets/product-catalog.yaml; infrastructure/datasets/trading-scenarios.yaml; infrastructure/datasets/financial-trading-scenarios.yaml; infrastructure/datasets/performance-customer-profiles.yaml; infrastructure/datasets/validation-customer-profiles.yaml; infrastructure/datasets/customer-profiles.yaml; infrastructure/datasets/product-catalog.yaml; infrastructure/datasets/trading-scenarios.yaml; infrastructure/datasets/financial-trading-scenarios.yaml; infrastructure/datasets/validation-customer-profiles.yaml; infrastructure/datasets/customer-profiles.yaml; infrastructure/datasets/product-catalog.yaml; infrastructure/datasets/trading-scenarios.yaml |
| DynamicMethodExecutionDemo | evaluation/dynamic-method-execution-demo.yaml; evaluation/dynamic-execution/settlement-processing-config.yaml; evaluation/dynamic-execution/risk-management-config.yaml; evaluation/dynamic-execution/pricing-service-config.yaml; evaluation/dynamic-execution/compliance-service-config.yaml; evaluation/dynamic-execution/dynamic-rules-config.yaml; evaluation/dynamic-execution/dynamic-test-data.yaml |
| ExternalDataSourceDemo | enrichment/external-data-source-demo-config.yaml |
| ExternalDataSourceReferenceDemo | lookup/customer-profile-enrichment.yaml; lookup/settlement-instruction-enrichment.yaml |
| ExternalDataSourceWorkingDemo | lookup/customer-profile-enrichment.yaml |
| FinancialStaticDataProvider | infrastructure/financial-static-data-provider.yaml; infrastructure/datasets/financial-clients.yaml; infrastructure/datasets/financial-counterparties.yaml; infrastructure/datasets/financial-currencies.yaml; infrastructure/datasets/financial-commodities.yaml; infrastructure/datasets/financial-clients.yaml; infrastructure/datasets/financial-client-accounts.yaml; infrastructure/datasets/financial-counterparties.yaml; infrastructure/datasets/financial-currencies.yaml; infrastructure/datasets/financial-commodities.yaml; infrastructure/datasets/financial-clients.yaml; infrastructure/datasets/financial-client-accounts.yaml; infrastructure/datasets/financial-counterparties.yaml; infrastructure/datasets/financial-currencies.yaml; infrastructure/datasets/financial-commodities.yaml |
| FluentRuleBuilderExample | evaluation/fluent-rule-builder-demo.yaml; evaluation/fluent-rule-builder/customer-processing-contexts-config.yaml; evaluation/fluent-rule-builder/rule-chain-definitions-config.yaml; evaluation/fluent-rule-builder/fluent-api-patterns-config.yaml |
| IntegratedCustomerValidatorDemo | validation/integrated-customer-validator-demo.yaml; validation/integrated-customer/validation-rules-config.yaml; validation/integrated-customer/customer-samples-config.yaml; validation/integrated-customer/validation-parameters-config.yaml |
...
- `enrichment/custody-bootstrap/settlement-scenarios-config.yaml` (referenced by: CustodyAutoRepairBootstrap)
...
- `evaluation/dynamic-execution/pricing-service-config.yaml` (referenced by: DynamicMethodExecutionDemo)
...
- `evaluation/trade-record-matcher-demo.yaml` (referenced by: TradeRecordMatcherDemo)
...
- `validation/integrated-product/product-validation-parameters-config.yaml` (referenced by: IntegratedProductValidatorDemo)
...
| enrichment\otc-options-bootstrap-demo.yaml | excellent | 8975 |
...
| evaluation\fluent-rule-builder\customer-processing-contexts-config.yaml | excellent | 14037 |
...
| evaluation\yaml-configuration-demo-config.yaml | excellent | 10383 |
...
| util\dependency-analysis\scenario-files-config.yaml | excellent | 11446 |
